        ...
        <Card className="border-border/50 bg-card/60">
          {step === 'credentials' ? (
            <>
              ...
              <Button variant="outline" onClick={handleGoogleLogin} disabled={loading} className="w-full font-bold">
              ...
              <Button variant="secondary" onClick={loginWithLinkedIn} disabled={loading} className="w-full mt-3">
              ...
              <p className="text-center text-sm font-medium text-muted-foreground mt-8">
                ...
                <Link to="/register" className="text-primary hover:text-primary/80 font-bold transition-colors underline decoration-primary/30 underline-offset-4">Sign up</Link>
              </p>
            </>
          ) : (
            <>
              <div className="flex flex-col items-center mb-6">
                <div className="p-3 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-4">
              ...
              <form onSubmit={handleTotpSubmit}>
                <Input
                  ...
                  required
                />
                <Button type="submit" loading={totpLoading} disabled={useBackup ? totpToken.length < 4 : totpToken.length !== 6} className="w-full mt-2">
                  Verify & Sign In
                </Button>
              </form>
